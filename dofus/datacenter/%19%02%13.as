class dofus.§\x17\x04\x19§.§\x19\x02\x13§ extends dofus.§\x17\x04\x19§.§\x16\x19\x02§
{
   function §\x19\x02\x13§(sID, §\x16\x1c\x16§, §\x1a\x1b\x1b§, §\x16\x17\x18§, §\x17\x07\x13§, §\x18\x02\x16§, bShowIsPlayer)
   {
      super();
