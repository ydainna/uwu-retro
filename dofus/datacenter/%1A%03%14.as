class dofus.§\x17\x04\x19§.§\x1a\x03\x14§ extends dofus.§\x17\x04\x19§.§\x1a\x05\t§
{
   function §\x1a\x03\x14§(sID, §\x16\x1c\x16§, §\x1a\x1b\x1b§, §\x16\x17\x18§, §\x17\x07\x13§, §\x18\x02\x16§, nModelID)
   {
      super();
