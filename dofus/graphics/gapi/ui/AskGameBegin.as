class dofus.graphics.gapi.ui.AskGameBegin extends dofus.graphics.gapi.core.§\x17\t\n§
{
   ...
   function click(oEvent)
   {
      ...
      {
         this.api.kernel.TipsManager.showNewTip(dofus.managers.TipsManager["\x1b\x10\x14"]);
