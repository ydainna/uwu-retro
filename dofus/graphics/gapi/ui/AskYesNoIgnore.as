class dofus.§\x18\x03\x10§.gapi.ui.AskYesNoIgnore extends ank.gapi.ui.FlyWindow
{
   static var §\x16\x1b\x10§ = "AskYesNoIgnore";
   ...
   function §\x1a\x0b§(§\x1b\x06\x1a§)
   {
      this["\x1e\x0b\x16"] = _loc2_;
      return this["\x06\x0b"]();
   }
   function §\x06\x0b§()
   {
      return this["\x1e\x0b\x16"];
   }
   function §\x16\x15\n§()
   {
   ...
   function §\x18\n\x16§()
   {
      ...
      _loc2_["\x1e\x0f\x0f"].text = "<u><font color=\'255\'><a href=\"asfunction:onHref,\">" + this.api.lang.getText("POPUP_ADD_IGNORE",[this["\x1e\x0b\x16"]]) + "</a></font></u>";
      _loc2_["\x1e\x0f\x0f"].addEventListener("href",this);
   ...
   function change(oEvent)
   {
      ...
      _loc3_["\x1e\x0f\x0f"]._y = _loc3_._btnNo._y + _loc3_._btnNo.height + 10;
   ...
   {
      this.params.player = this["\x1e\x0b\x16"];
      this["\x17\x07\x19"]({type:"ignore",params:this.params});
      this["\x1b\x13\x13"]();
   }
}
