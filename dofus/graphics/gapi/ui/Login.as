class dofus.graphics.gapi.ui.Login extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function autoLogin(sLogin, sPass)
   {
      ...
      {
         this.sLogin.text = _loc2_;
         this.sPass.text = _loc3_;
   ...
   function zaapAutoLogin(bForce)
   {
      ...
      if(!bForce && 7121 - this._nLastRegisterTime < 1000)
      {
         return undefined;
      }
      this.disableZaapConnectButton(this.api.lang.getText("LOADER_AUTO_LOGIN"));
      this._nLastRegisterTime = 2460;
   ...
   function refreshAutoLoginUi()
   {
      ...
      this.sLogin._visible = !_loc2_;
      this.sPass._visible = !_loc2_;
   ...
   function initSavedAccount()
   {
      ...
      {
         this.sLogin.text = this.api.kernel.OptionsManager.getOption("LastAccountNameUsed");
         this.sPass.setFocus();
      }
   };
   ...
   function initTexts()
   {
      ...
      new org.flashdevelop.utils.FlashConnect.trace("api.config.isStreaming : " + _global.CONFIG.isStreaming,"dofus.graphics.gapi.ui.Login::initTexts","C:\\Users\\ddallinge\\Git\\client\\src\\core\\classes/dofus/graphics/gapi/ui/Login.as",583);
   ...
   function initInput()
   {
      ...
      this.sLogin.tabIndex = 1;
      this.sPass.tabIndex = 2;
      this._btnOK.tabIndex = 3;
      this.sPass.password = true;
      var _loc2_ = false;
      if(dofus.Constants.DEBUG)
      {
         this.sLogin.restrict = "\\-a-zA-Z0-9|@+._[]";
         this.sLogin.maxChars = 50;
         var _loc3_ = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.loginInfos;
         if(_loc3_ != undefined)
         {
            this.sLogin.text = _loc3_.account;
            this.sPass.text = _loc3_.password;
            _loc2_ = true;
         }
      }
      else
   ...
   function onShortcut(sShortcut)
   {
      ...
      new org.flashdevelop.utils.FlashConnect.trace(sShortcut,"dofus.graphics.gapi.ui.Login::onShortcut","C:\\Users\\ddallinge\\Git\\client\\src\\core\\classes/dofus/graphics/gapi/ui/Login.as",1013);
      ...
      {
         this.onLogin(this.sLogin.text,this.sPass.text);
         return false;
      }
      return true;
   };
   ...
   function onLogin(sLogin, sPassword, §\x16\x15\x04§)
   {
      if(this.api.electron.enabled && !this.api.electron.hasSystemInformations())
      {
         ...
         _global.setTimeout(this,"onLogin",200,sLogin,sPassword,_loc4_);
         return undefined;
      }
      if(!dofus.Constants.DEBUG && this.sPass.text != undefined)
      {
         this.sPass.text = "";
      }
      if(sLogin == undefined)
      ...
      if(this._sServerIP == undefined)
      {
         ...
         new org.flashdevelop.utils.FlashConnect.trace("[Login] (onLogin) IP : " + _loc7_,"dofus.graphics.gapi.ui.Login::onLogin","C:\\Users\\ddallinge\\Git\\client\\src\\core\\classes/dofus/graphics/gapi/ui/Login.as",1236);
   ...
   function close(oEvent)
   {
      ...
      _loc3_.flush();
      this.sLogin.tabEnabled = true;
      this.sPass.tabEnabled = true;
   ...
   function click(oEvent)
   {
      switch(oEvent.target._name)
      {
         ...
         case "_btnCopyrights":
            ...
            break;
         case "_btnOK":
            this.onLogin(this.sLogin.text,this.sPass.text,false);
            break;
         case "_mcAutoconnect":
            this.zaapAutoLogin(false);
            break;
         case "_mcSubscribe":
            if(6965 - this._nLastRegisterTime < 1000)
            {
               return undefined;
            }
            this._nLastRegisterTime = 3115;
            if(this.api.lang.getConfigText("REGISTER_INGAME"))
            {
               this.sLogin.tabEnabled = false;
               this.sPass.tabEnabled = false;
            ...
            {
               new org.flashdevelop.utils.FlashConnect.trace("open : " + this.api.lang.getConfigText("REGISTER_POPUP_LINK"),"dofus.graphics.gapi.ui.Login::click","C:\\Users\\ddallinge\\Git\\client\\src\\core\\classes/dofus/graphics/gapi/ui/Login.as",1332);
