class dofus.§\x18\x03\x10§.gapi.§\x17\x01\x06§.SpouseViewer extends dofus.§\x18\x03\x10§.gapi.§\x17\x01\x0f§.§\x17\t\n§
{
   ...
   function §\x1b\x14\x14§()
   {
      ...
      {
         this["\x1e\x10\t"].title = ank.utils.["\x1a\x04\t"]["\x16\x1d\x15"](this.api.lang.getText("SPOUSE"),this["\x1e\x05\x19"]["\x1a\x1b\f"],true);
         this._lblSpouse.text = ank.utils.["\x1a\x04\t"]["\x16\x1d\x15"](this.api.lang.getText("SPOUSE"),this["\x1e\x05\x19"]["\x1a\x1b\f"],true);
         ...
         else if(this["\x1c\x1a\x07"].text != undefined)
         {
            ...
            this["\x1c\x12\x15"].text = ank.utils.["\x1a\x04\t"]["\x16\x1d\x15"](this.api.lang.getText("SPOUSE_NOT_CONNECTED"),this["\x1e\x05\x19"]["\x1a\x1b\f"],true);
            this["\x1c\x15\x12"].text = "";
