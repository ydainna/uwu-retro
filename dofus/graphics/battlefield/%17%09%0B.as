class dofus.§\x18\x03\x10§.battlefield.§\x17\t\x0b§ extends ank.battlefield.§\x16\t\t§
{
   ...
   function §\x19\x1a\x07§()
   {
      ...
      if(this.api.kernel.OptionsManager.getOption("Grid") == true || this.api.datacenter.Game["\x18\x0f\x12"])
      {
         this.api.gfx["\x17\n\x04"]();
      }
      else
   ...
   function §\x19\x15\x04§(§\x18\x1b\x10§)
   {
      ...
      switch(this.api.datacenter.Game["\x18\x0b\t"])
      {
         case 1:
            ...
            if(this.api.datacenter.Player["\x18\x0b\b"]["\x16\x15\b"](this["\x18\x18\x15"],_loc2_.num,true,this.api.datacenter.Game["\x18\r\x15"],false,_loc5_))
            {
               if(this.api.datacenter.Game["\x18\r\x15"])
               {
                  _loc4_ = true;
            ...
            if(!this.api.datacenter.Game["\x18\r\x15"] && !_loc4_)
            {
               if(this.api.datacenter.Player["\x18\x0b\b"]["\x16\x15\b"](this["\x18\x18\x15"],_loc2_.num,true,this.api.datacenter.Game["\x18\r\x15"],true,_loc5_))
               {
                  _loc4_ = true;
               }
            }
            if(_loc4_)
            {
               if(10022 - this.api.datacenter.Basics.gfx_lastActionTime < dofus.Constants["\x16\x1c\x14"] && (_loc3_ == undefined || !_loc3_["\x18\f\x10"]))
               {
         ...
         case 2:
            if(this.api.datacenter.Player["\x17\x03\x1d"] != null && this.api.datacenter.Basics.gfx_canLaunch == true)
            {
               ...
               _loc9_.addAction(123,false,_loc8_["\x17\x13\x05"],_loc8_["\x17\x13\x05"]["\x1b\x11\x0b"],[300,[this.api.datacenter.Player["\x17\x03\x1d"].ID,_loc2_.num]]);
               _loc9_.execute();
         ...
         case 3:
            if(this.api.datacenter.Player["\x17\x03\x1d"] != null && this.api.datacenter.Basics.gfx_canLaunch == true)
            {
               ...
               _loc11_.addAction(124,false,_loc10_["\x17\x13\x05"],_loc10_["\x17\x13\x05"]["\x1b\x11\x0b"],[303,[_loc2_.num]]);
               _loc11_.execute();
               this.api.datacenter.Player["\x17\x03\x1d"] = null;
            }
            this.api.ui.removeCursor();
         ...
         case 6:
            if(this.api.datacenter.Game["\x18\r\x15"])
            {
               ...
               this.api.ui.removeCursor();
               if(this.api.datacenter.Game["\x18\x0f\x12"] && this.api.datacenter.Game["\x17\x03\x1a"] == this.api.datacenter.Player.ID)
               {
   ...
   function §\x19\x15\x06§(§\x18\x1b\x10§)
   {
      ...
      if(this.api.datacenter.Game["\x18\x0f\x12"] && (!this.api.datacenter.Player.isCurrentPlayer && this.api.datacenter.Game["\x18\x0b\t"] != 6))
      {
         return undefined;
      }
      switch(this.api.datacenter.Game["\x18\x0b\t"])
      {
         case 1:
            ...
            var _loc6_ = this.api.datacenter.["\x1b\x07\x0e"].getItemAt(_loc5_);
            if(_loc6_ != undefined)
            {
            ...
            if(ank.battlefieldutils.["\x1a\x04\b"]["\x16\x1a\x18"](this["\x18\x18\x15"],_loc4_.cellNum,_loc2_.num,false,0,_loc4_.MP,0))
            {
               ...
               this.api.datacenter.Player["\x18\x0b\b"]["\x16\x15\b"](this["\x18\x18\x15"],_loc2_.num,false,this.api.datacenter.Game["\x18\r\x15"]);
            }
            else
            {
               delete this.api.datacenter.Basics.interactionsManager_path;
   ...
   function §\x19\x1d\x05§(§\x18\x1c\x03§, §\x16\x11\t§)
   {
      ...
      if((_loc0_ = this.api.datacenter.Game["\x18\x0b\t"]) !== 5)
      {
         ...
         {
            if(this.api.datacenter.Game["\x18\r\x15"] && (this.api.datacenter.Game["\x18\x0f\x12"] && !(this.api.datacenter.Player.isAuthorized && (this.api.datacenter.Game["\x18\x0b\t"] == dofus.datacenter..Game["\x18\x0b\x19"] && this.api.datacenter.Player["\x17\x03\x1d"] == null))))
            {
         ...
         else if(_loc4_ instanceof dofus.datacenter.["\x1b\x0e\x15"])
         {
            ...
            if(_loc29_)
            {
               ...
               var _loc32_ = this.api.lang["\x17\x1b\n"](this.api.datacenter.["\x18\x18\x0e"].id);
               var _loc33_ = this.api.lang["\x17\x1b\t"](this.api.datacenter.["\x18\x18\x0e"].id);
         ...
         {
            if(_loc4_["\x1a\x03\x06"] == this.api.datacenter.Player.Name || this.api.datacenter.["\x18\x18\x0e"].firstMountPark["\x18\x04\x07"] == this.api.datacenter.Player.guildInfos.name && this.api.datacenter.Player.guildInfos["\x1a\x05\x15"]["\x16\x16\t"])
            {
               if(Key.isDown(Key.SHIFT) || _loc3_)
               {
         ...
         else if(_loc4_ instanceof dofus.datacenter.["\x18\x1d\x19"] || _loc4_ instanceof dofus.datacenter.["\x18\x1d\x18"])
         {
            ...
            if(!this.api.datacenter.Player.isMutant || (this.api.datacenter.Player.canAttackDungeonMonstersWhenMutant || this.api.datacenter.Player.canAttackMonstersAnywhereWhenMutant))
            {
               ...
               if(!Key.isDown(Key.SHIFT) && (!_loc3_ && (!this.api.datacenter.Game["\x18\r\x15"] && _loc4_ instanceof dofus.datacenter.["\x18\x1d\x19"])))
               {
   ...
   function §\x19\x1d\x07§(§\x18\x1c\x03§, §\x16\x0b\x10§)
   {
      ...
      if(this.api.datacenter.Game["\x18\x0f\x12"] || this.api.datacenter.Game["\x18\x0b\t"] == 5)
      {
      ...
      if(_loc6_ instanceof dofus.datacenter.["\x19\x02\x13"] && _loc6_["\x1a\x1d\x1c"])
      {
         if(this.api.datacenter.Game["\x18\x0f\x12"])
         {
            ...
            {
               _loc10_ = "";
               this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield.HealthBarOverHead,[_loc6_,100]);
            }
            else
            {
      ...
      else if(_loc6_ instanceof dofus.datacenter.["\x16\x19\x02"])
      {
         ...
         if(this.api.datacenter.Game["\x18\x0f\x12"])
         {
            this["\x15\x1e\x15"](_loc6_.id,"effects",dofus.graphics.battlefield["\x17\f\f"],[_loc6_]);
            if(this.api.kernel.OptionsManager.getOption("ViewHPAsBar"))
            {
               _loc10_ = "";
               this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield.HealthBarOverHead,[_loc6_,100,_loc4_,_loc5_]);
            }
            else
            {
               _loc10_ += " (" + _loc6_.LP + ")";
         ...
         else if(this.api.datacenter.Game["\x18\r\x15"])
         {
            _loc10_ += " (" + _loc6_.Level + ")";
         }
         ...
         {
            _loc10_ = "";
            this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x18\x04\b"],[_loc6_["\x18\x04\x07"],_loc6_.name,_loc6_["\x17\f\x14"],_loc4_,_loc5_,_loc6_.pvpGain,_loc8_],undefined,true);
         }
      }
      else if(_loc6_ instanceof dofus.datacenter.["\x1b\x0e\x04"])
      {
         ...
         {
            _loc10_ = "";
            this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x18\x04\b"],[_loc6_["\x18\x04\x07"],_loc6_.name,_loc6_["\x17\f\x14"]]);
         }
      }
      else if(_loc6_ instanceof dofus.datacenter.["\x1a\x07\x0b"])
      {
         ...
         _loc7_ = dofus.Constants["\x19\f\x02"][_loc6_.alignment.index];
         this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x1b\x0f\x15"],[_loc10_,_loc4_,_loc7_,_loc5_]);
      }
      ...
      else if(_loc6_ instanceof dofus.datacenter.["\x19\x12\x19"])
      {
         _loc7_ = dofus.Constants["\x1a\x02\x1c"];
         _loc10_ = "";
         this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x19\x12\x1b"],[_loc6_]);
      }
      else if(_loc6_ instanceof dofus.datacenter.["\x19\x0b\x07"])
      {
         var _loc12_ = this.api.datacenter.["\x18\x18\x0e"];
      ...
      else if(_loc6_ instanceof dofus.datacenter.["\x18\x1d\x19"] || _loc6_ instanceof dofus.datacenter.["\x1b\x0e\x15"])
      {
         ...
         if(_loc6_["\x18\x10\x0e"] && (_loc6_ instanceof dofus.datacenter.["\x18\x1d\x19"] || _loc6_.type == 1 && (_loc14_ == 2 || (_loc14_ == 3 || _loc14_ == 4))))
         {
            if(_loc10_ != "")
            {
               ...
               this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x1b\x0f\x16"],[_loc10_,_loc4_,_loc7_,_loc5_,this.api.lang.getText("LEVEL") + " " + _loc6_["\x1b\x11\x05"],_loc15_,_loc6_["\x16\x0f\x1c"]]);
            }
      ...
      if(_loc10_ != "")
      {
         this["\x15\x1e\x15"](_loc6_.id,"text",dofus.graphics.battlefield["\x1b\x0f\x15"],[_loc10_,_loc4_,_loc7_,_loc5_,_loc6_,_loc8_]);
      }
      this["\x1a\x13\x0f"](_loc6_.id,true);
   }
   ...
   function §\x19\x1a\x1a§(§\x18\x1b\x1b§, §\x16\x11\t§)
   {
      ...
      if(_loc7_ != undefined)
      {
         ...
         {
            if(this.api.datacenter.["\x18\x18\x0e"].firstMountPark["\x18\x0e\x1c"](this.api))
            {
      ...
      if(!_global.isNaN(_loc6_) && (this.api.datacenter.Player.canUseInteractiveObjects && this.api.datacenter.Game["\x18\x0b\t"] != 5))
      {
         ...
         switch(_loc12_)
         {
            ...
            case 15:
               ...
               if(_loc13_)
               {
                  ...
                  if(_loc14_ != undefined)
                  {
                     ...
                     var _loc16_ = _loc15_ < dofus.Constants["\x16\x1c\x14"];
                     if(_loc16_)
                     {
               ...
               break;
            case 5:
               var _loc28_ = this.api.lang["\x17\x18\x17"](this.api.datacenter.["\x18\x18\x0e"].id,_loc5_.num);
            ...
            case 6:
               ...
               var _loc32_ = this.api.datacenter.["\x18\x18\x0e"].isMyHome;
               var _loc33_ = true;
               var _loc34_ = this.api.ui["\x17\x02\x19"]();
               ...
               break;
            case 13:
               var _loc39_ = this.api.datacenter.["\x18\x18\x0e"].firstMountPark;
   ...
   function §\x19\x1a\x1c§(§\x18\x1b\x1b§)
   {
      ...
      if(_loc6_ != undefined)
      {
         ...
         this.api.datacenter.["\x1b\x07\x0e"]["\x15\x1d\x13"]("itemOnCell",_loc8_);
         this.api.gfx.addSprite("itemOnCell");
         this["\x15\x1e\x15"]("itemOnCell","text",dofus.graphics.battlefield["\x1b\x0f\x15"],[_loc7_,"",dofus.Constants["\x1a\x02\x1c"]]);
      }
      var _loc9_ = this.api.lang["\x17\x19\n"](_loc5_);
      var _loc10_ = _loc9_.n;
      var _loc11_ = _loc9_.sk;
      ...
      {
         case 5:
            var _loc13_ = this.api.lang["\x17\x18\x17"](this.api.datacenter.["\x18\x18\x0e"].id,_loc4_.num);
            ...
            this.api.datacenter.["\x1b\x07\x0e"]["\x15\x1d\x13"]("porte",_loc15_);
            this.api.gfx.addSprite("porte");
            this["\x15\x1e\x15"]("porte","text",dofus.graphics.battlefield.PropertyOverHead,[_loc14_,"HouseIcon"]);
            break;
         case 13:
            var _loc16_ = this.api.datacenter.["\x18\x18\x0e"].firstMountPark;
            var _loc17_ = new dofus.datacenter.["\x16\x19\x02"]("enclos",ank.battlefield.mc.Sprite,"",_loc4_.num,0,0);
            this.api.datacenter.["\x1b\x07\x0e"]["\x15\x1d\x13"]("enclos",_loc17_);
            this.api.gfx.addSprite("enclos");
            var _loc18_ = this.api.datacenter.["\x18\x18\x0e"].mountParks;
            this["\x15\x1e\x15"]("enclos","text",dofus.graphics.battlefield.MountParkOverHead,[_loc18_,"FarmIcon"]);
      }
   }
