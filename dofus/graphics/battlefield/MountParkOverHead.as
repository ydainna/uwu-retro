class dofus.graphics.battlefield.MountParkOverHead extends dofus.graphics.battlefield.AbstractTextOverHead
{
   ...
   {
      super.initialize();
      this.createTextField("_txtName",30,0,-2 + dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"],0,0);
      this.createTextField("_txtInfo",40,0,9 + dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"],0,0);
      this.createTextField("_txtOwnerName",50,0,25 + dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"],0,0);
   ...
   function drawClip(§\x17\x0b\t§, sIconFile)
   {
      ...
      this._txtName.setNewTextFormat(dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x0f\x19"]);
      ...
      this._txtInfo.setNewTextFormat(dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x0f\x19"]);
      ...
      while(_loc9_ < _loc2_.length)
      {
         ...
         if(!_loc10_["\x18\x0f\x0e"])
         {
            ...
            if(!_loc5_ && (_loc10_["\x18\x04\x07"] != undefined && _loc10_["\x18\x04\x07"].length != 0))
            {
               ...
               _loc12_.setNewTextFormat(dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x0f\x19"]);
      ...
      var _loc16_ = 0;
      var _loc14_ = Math.ceil(30 + this._txtOwnerName.textHeight + dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"] * 2);
      var _loc15_ = Math.ceil(Math.max(Math.max(this._txtName.textWidth,this._txtOwnerName.textWidth),this._txtInfo.textWidth) + dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x19\x0b"] * 4) + 30;
      if(_loc4_)
      {
         _loc15_ += dofus.graphics.battlefield.MountParkOverHead.EMBLEM_SIZE + dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x19\x0b"];
      }
      this._txtInfo._x = this._txtName._x = this._txtOwnerName._x = (0 - _loc15_) / 2 + 30 + dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x19\x0b"] * 2;
      if(_loc5_ && (_loc6_["\x18\x04\x07"] != undefined && (_loc6_["\x18\x04\x07"] != "" && !_loc6_["\x18\x0f\x0e"])))
      {
         _loc8_.attachMovie("Emblem","_eEmblem",100,{_y:dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"],_height:30,_width:30,data:_loc6_["\x18\x04\x01"],shadow:true});
      }
      else
      {
         var _loc17_ = ank.gapi.controls.Loader(this.attachMovie("GAPILoader","_ldrIcon",100,{contentPath:sIconFile,_height:30,_width:30,_x:Math.ceil((0 - _loc15_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x19\x0b"],_y:dofus.graphics.battlefield.AbstractTextOverHead["\x18\x05\x14"],scaleContent:true}));
      }
      _loc8_._x = Math.ceil((0 - _loc15_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead["\x1b\x19\x0b"];
      this["\x17\t\x18"](_loc15_,_loc14_,dofus.graphics.battlefield.AbstractTextOverHead["\x16\b\x0b"]);
   }
}
