class dofus.§\x18\x03\x10§.battlefield.§\x1b\x0f\x16§ extends dofus.§\x18\x03\x10§.battlefield.§\x15\x1b\f§
{
   ...
   function initialize(§\x1b\t\x15§)
   {
      ...
      this["\x1d\x1d\n"] = _loc3_;
      this.createTextField("_txtTitle",40,0,-3 + dofus.graphics.battlefield["\x15\x1b\f"]["\x18\x05\x14"] + 4,0,0);
      this.createTextField("_txtText",30,0,-3 + dofus.graphics.battlefield["\x15\x1b\f"]["\x18\x05\x14"] * (this["\x1d\x1d\n"] <= -1 ? 1 : 2) + 20 + (this["\x1d\x1d\n"] <= -1 ? 0 : dofus.graphics.battlefield["\x1b\x0f\x16"]["\x1b\t\b"]),0,0);
   ...
   function drawClip(sText, §\x1a\x1b\x0f§, §\x19\x05\x06§, §\x19\x07\x19§, sTitle, §\x19\x05\n§)
   {
      ...
      this._txtText.setTextFormat(dofus.graphics.battlefield["\x15\x1b\f"]["\x1b\x0f\x17"]);
      if(_loc4_ != undefined)
      {
      ...
      this._txtTitle.setTextFormat(dofus.graphics.battlefield["\x15\x1b\f"]["\x1b\x0f\x17"]);
      if(_loc7_ != undefined)
      {
      ...
      var _loc9_ = Math.ceil(this._txtText.textHeight + 20 + dofus.graphics.battlefield["\x15\x1b\f"]["\x18\x05\x14"] * (this["\x1d\x1d\n"] <= -1 ? 3 : 4) + (this["\x1d\x1d\n"] <= -1 ? 0 : dofus.graphics.battlefield["\x1b\x0f\x16"]["\x1b\t\b"]));
      var _loc10_ = Math.ceil(Math.max(Math.max(this._txtText.textWidth,this._txtTitle.textWidth),this["\x1d\x1d\n"] <= -1 ? 0 : this["\x1d\x16\x11"]) + dofus.graphics.battlefield["\x15\x1b\f"]["\x1b\x19\x0b"] * 2);
      ...
      if(this["\x1d\x1d\n"] > -1)
      {
         ...
         while(_loc12_ < dofus.graphics.battlefield["\x1b\x0f\x16"]["\x1b\t\x06"])
         {
            ...
            _loc13_._x = _loc12_ * (dofus.graphics.battlefield["\x1b\x0f\x16"]["\x1b\t\b"] + dofus.graphics.battlefield["\x1b\x0f\x16"]["\x1b\t\x07"]) - this["\x1d\x16\x11"] / 2 + dofus.graphics.battlefield["\x15\x1b\f"]["\x1b\x19\x0b"];
            _loc13_._y = dofus.graphics.battlefield["\x15\x1b\f"]["\x18\x05\x14"] * 4 + this._txtTitle.textHeight;
