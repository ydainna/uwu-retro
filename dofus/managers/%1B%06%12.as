class dofus.§\x18\x18\x0b§.§\x1b\x06\x12§
{
   ...
   {
      if(!this.api.datacenter.Game.isRunning || (this.api.datacenter.Game["\x18\x0f\x1b"] || (!this.api.gfx.isOnBattlefield(this.api.datacenter.Player.ID) || this.api.datacenter.Player.isDead)))
      {
